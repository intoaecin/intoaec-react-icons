...
export const ViewProposalIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg width='15' height='15' viewBox='0 0 12 13' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path
